...
func (_IConsensus *IConsensusCaller) WasInputFinalized(opts *bind.CallOpts, appContract common.Address, inputIndex *big.Int, blockNumber *big.Int) (bool, error) {
	var out []interface{}
	err := _IConsensus.contract.Call(opts, &out, "wasInputFinalized", appContract, inputIndex, blockNumber)
...
//
// Solidity: function wasInputFinalized(address appContract, uint256 inputIndex, uint256 blockNumber) view returns(bool)
func (_IConsensus *IConsensusSession) WasInputFinalized(appContract common.Address, inputIndex *big.Int, blockNumber *big.Int) (bool, error) {
	return _IConsensus.Contract.WasInputFinalized(&_IConsensus.CallOpts, appContract, inputIndex, blockNumber)
}

// WasInputFinalized is a free data retrieval call binding the contract method 0x2b73ad31.
//
// Solidity: function wasInputFinalized(address appContract, uint256 inputIndex, uint256 blockNumber) view returns(bool)
func (_IConsensus *IConsensusCallerSession) WasInputFinalized(appContract common.Address, inputIndex *big.Int, blockNumber *big.Int) (bool, error) {
	return _IConsensus.Contract.WasInputFinalized(&_IConsensus.CallOpts, appContract, inputIndex, blockNumber)
}
...
func (_IConsensus *IConsensusTransactor) SubmitClaim(opts *bind.TransactOpts, appContract common.Address, lastProcessedBlockNumber *big.Int, machineMerkleRoot [32]byte, proof MachineValidityProof) (*types.Transaction, error) {
	return _IConsensus.contract.Transact(opts, "submitClaim", appContract, lastProcessedBlockNumber, machineMerkleRoot, proof)
}

// SubmitClaim is a paid mutator transaction binding the contract method 0x92ebd98c.
//
// Solidity: function submitClaim(address appContract, uint256 lastProcessedBlockNumber, bytes32 machineMerkleRoot, ((bytes32,bytes32[]),(bytes32,bytes32[]),(bytes32,bytes32[])) proof) returns()
func (_IConsensus *IConsensusSession) SubmitClaim(appContract common.Address, lastProcessedBlockNumber *big.Int, machineMerkleRoot [32]byte, proof MachineValidityProof) (*types.Transaction, error) {
	return _IConsensus.Contract.SubmitClaim(&_IConsensus.TransactOpts, appContract, lastProcessedBlockNumber, machineMerkleRoot, proof)
}

// SubmitClaim is a paid mutator transaction binding the contract method 0x92ebd98c.
//
// Solidity: function submitClaim(address appContract, uint256 lastProcessedBlockNumber, bytes32 machineMerkleRoot, ((bytes32,bytes32[]),(bytes32,bytes32[]),(bytes32,bytes32[])) proof) returns()
func (_IConsensus *IConsensusTransactorSession) SubmitClaim(appContract common.Address, lastProcessedBlockNumber *big.Int, machineMerkleRoot [32]byte, proof MachineValidityProof) (*types.Transaction, error) {
	return _IConsensus.Contract.SubmitClaim(&_IConsensus.TransactOpts, appContract, lastProcessedBlockNumber, machineMerkleRoot, proof)
}
