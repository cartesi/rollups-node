...
// CalculateDaveAppAddress is a free data retrieval call binding the contract method 0x5592ff8a.
//
// Solidity: function calculateDaveAppAddress(bytes32 templateHash, uint256 claimStagingPeriod, address sentryManager, address[] sentries, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) view returns(address appContractAddress, address daveConsensusAddress)
func (_IDaveAppFactory *IDaveAppFactoryCaller) CalculateDaveAppAddress(opts *bind.CallOpts, templateHash [32]byte, claimStagingPeriod *big.Int, sentryManager common.Address, sentries []common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (struct {
	AppContractAddress   common.Address
	DaveConsensusAddress common.Address
}, error) {
	var out []interface{}
	err := _IDaveAppFactory.contract.Call(opts, &out, "calculateDaveAppAddress", templateHash, claimStagingPeriod, sentryManager, sentries, withdrawalConfig, salt)
...
//
// Solidity: function calculateDaveAppAddress(bytes32 templateHash, uint256 claimStagingPeriod, address sentryManager, address[] sentries, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) view returns(address appContractAddress, address daveConsensusAddress)
func (_IDaveAppFactory *IDaveAppFactorySession) CalculateDaveAppAddress(templateHash [32]byte, claimStagingPeriod *big.Int, sentryManager common.Address, sentries []common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (struct {
	AppContractAddress   common.Address
	DaveConsensusAddress common.Address
}, error) {
	return _IDaveAppFactory.Contract.CalculateDaveAppAddress(&_IDaveAppFactory.CallOpts, templateHash, claimStagingPeriod, sentryManager, sentries, withdrawalConfig, salt)
}

// CalculateDaveAppAddress is a free data retrieval call binding the contract method 0x5592ff8a.
//
// Solidity: function calculateDaveAppAddress(bytes32 templateHash, uint256 claimStagingPeriod, address sentryManager, address[] sentries, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) view returns(address appContractAddress, address daveConsensusAddress)
func (_IDaveAppFactory *IDaveAppFactoryCallerSession) CalculateDaveAppAddress(templateHash [32]byte, claimStagingPeriod *big.Int, sentryManager common.Address, sentries []common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (struct {
	AppContractAddress   common.Address
	DaveConsensusAddress common.Address
}, error) {
	return _IDaveAppFactory.Contract.CalculateDaveAppAddress(&_IDaveAppFactory.CallOpts, templateHash, claimStagingPeriod, sentryManager, sentries, withdrawalConfig, salt)
...
// NewDaveApp is a paid mutator transaction binding the contract method 0x7ea1763b.
//
// Solidity: function newDaveApp(bytes32 templateHash, uint256 claimStagingPeriod, address sentryManager, address[] sentries, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) returns(address appContract, address daveConsensus)
func (_IDaveAppFactory *IDaveAppFactoryTransactor) NewDaveApp(opts *bind.TransactOpts, templateHash [32]byte, claimStagingPeriod *big.Int, sentryManager common.Address, sentries []common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (*types.Transaction, error) {
	return _IDaveAppFactory.contract.Transact(opts, "newDaveApp", templateHash, claimStagingPeriod, sentryManager, sentries, withdrawalConfig, salt)
}

// NewDaveApp is a paid mutator transaction binding the contract method 0x7ea1763b.
//
// Solidity: function newDaveApp(bytes32 templateHash, uint256 claimStagingPeriod, address sentryManager, address[] sentries, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) returns(address appContract, address daveConsensus)
func (_IDaveAppFactory *IDaveAppFactorySession) NewDaveApp(templateHash [32]byte, claimStagingPeriod *big.Int, sentryManager common.Address, sentries []common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (*types.Transaction, error) {
	return _IDaveAppFactory.Contract.NewDaveApp(&_IDaveAppFactory.TransactOpts, templateHash, claimStagingPeriod, sentryManager, sentries, withdrawalConfig, salt)
}

// NewDaveApp is a paid mutator transaction binding the contract method 0x7ea1763b.
//
// Solidity: function newDaveApp(bytes32 templateHash, uint256 claimStagingPeriod, address sentryManager, address[] sentries, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) returns(address appContract, address daveConsensus)
func (_IDaveAppFactory *IDaveAppFactoryTransactorSession) NewDaveApp(templateHash [32]byte, claimStagingPeriod *big.Int, sentryManager common.Address, sentries []common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (*types.Transaction, error) {
	return _IDaveAppFactory.Contract.NewDaveApp(&_IDaveAppFactory.TransactOpts, templateHash, claimStagingPeriod, sentryManager, sentries, withdrawalConfig, salt)
}
