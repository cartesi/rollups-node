...
func (_IQuorum *IQuorumCaller) WasInputFinalized(opts *bind.CallOpts, appContract common.Address, inputIndex *big.Int, blockNumber *big.Int) (bool, error) {
	var out []interface{}
	err := _IQuorum.contract.Call(opts, &out, "wasInputFinalized", appContract, inputIndex, blockNumber)
...
//
// Solidity: function wasInputFinalized(address appContract, uint256 inputIndex, uint256 blockNumber) view returns(bool)
func (_IQuorum *IQuorumSession) WasInputFinalized(appContract common.Address, inputIndex *big.Int, blockNumber *big.Int) (bool, error) {
	return _IQuorum.Contract.WasInputFinalized(&_IQuorum.CallOpts, appContract, inputIndex, blockNumber)
}

// WasInputFinalized is a free data retrieval call binding the contract method 0x2b73ad31.
//
// Solidity: function wasInputFinalized(address appContract, uint256 inputIndex, uint256 blockNumber) view returns(bool)
func (_IQuorum *IQuorumCallerSession) WasInputFinalized(appContract common.Address, inputIndex *big.Int, blockNumber *big.Int) (bool, error) {
	return _IQuorum.Contract.WasInputFinalized(&_IQuorum.CallOpts, appContract, inputIndex, blockNumber)
}
...
func (_IQuorum *IQuorumTransactor) SubmitClaim(opts *bind.TransactOpts, appContract common.Address, lastProcessedBlockNumber *big.Int, machineMerkleRoot [32]byte, proof MachineValidityProof) (*types.Transaction, error) {
	return _IQuorum.contract.Transact(opts, "submitClaim", appContract, lastProcessedBlockNumber, machineMerkleRoot, proof)
}

// SubmitClaim is a paid mutator transaction binding the contract method 0x92ebd98c.
//
// Solidity: function submitClaim(address appContract, uint256 lastProcessedBlockNumber, bytes32 machineMerkleRoot, ((bytes32,bytes32[]),(bytes32,bytes32[]),(bytes32,bytes32[])) proof) returns()
func (_IQuorum *IQuorumSession) SubmitClaim(appContract common.Address, lastProcessedBlockNumber *big.Int, machineMerkleRoot [32]byte, proof MachineValidityProof) (*types.Transaction, error) {
	return _IQuorum.Contract.SubmitClaim(&_IQuorum.TransactOpts, appContract, lastProcessedBlockNumber, machineMerkleRoot, proof)
}

// SubmitClaim is a paid mutator transaction binding the contract method 0x92ebd98c.
//
// Solidity: function submitClaim(address appContract, uint256 lastProcessedBlockNumber, bytes32 machineMerkleRoot, ((bytes32,bytes32[]),(bytes32,bytes32[]),(bytes32,bytes32[])) proof) returns()
func (_IQuorum *IQuorumTransactorSession) SubmitClaim(appContract common.Address, lastProcessedBlockNumber *big.Int, machineMerkleRoot [32]byte, proof MachineValidityProof) (*types.Transaction, error) {
	return _IQuorum.Contract.SubmitClaim(&_IQuorum.TransactOpts, appContract, lastProcessedBlockNumber, machineMerkleRoot, proof)
}
