...
// CalculateAddresses is a free data retrieval call binding the contract method 0x888d6843.
//
// Solidity: function calculateAddresses(address authorityOwner, uint256 epochLength, uint256 claimStagingPeriod, bytes32 templateHash, address inputBox, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) view returns(address, address)
func (_ISelfHostedApplicationFactory *ISelfHostedApplicationFactoryCaller) CalculateAddresses(opts *bind.CallOpts, authorityOwner common.Address, epochLength *big.Int, claimStagingPeriod *big.Int, templateHash [32]byte, inputBox common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (common.Address, common.Address, error) {
	var out []interface{}
	err := _ISelfHostedApplicationFactory.contract.Call(opts, &out, "calculateAddresses", authorityOwner, epochLength, claimStagingPeriod, templateHash, inputBox, withdrawalConfig, salt)
...
//
// Solidity: function calculateAddresses(address authorityOwner, uint256 epochLength, uint256 claimStagingPeriod, bytes32 templateHash, address inputBox, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) view returns(address, address)
func (_ISelfHostedApplicationFactory *ISelfHostedApplicationFactorySession) CalculateAddresses(authorityOwner common.Address, epochLength *big.Int, claimStagingPeriod *big.Int, templateHash [32]byte, inputBox common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (common.Address, common.Address, error) {
	return _ISelfHostedApplicationFactory.Contract.CalculateAddresses(&_ISelfHostedApplicationFactory.CallOpts, authorityOwner, epochLength, claimStagingPeriod, templateHash, inputBox, withdrawalConfig, salt)
}

// CalculateAddresses is a free data retrieval call binding the contract method 0x888d6843.
//
// Solidity: function calculateAddresses(address authorityOwner, uint256 epochLength, uint256 claimStagingPeriod, bytes32 templateHash, address inputBox, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) view returns(address, address)
func (_ISelfHostedApplicationFactory *ISelfHostedApplicationFactoryCallerSession) CalculateAddresses(authorityOwner common.Address, epochLength *big.Int, claimStagingPeriod *big.Int, templateHash [32]byte, inputBox common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (common.Address, common.Address, error) {
	return _ISelfHostedApplicationFactory.Contract.CalculateAddresses(&_ISelfHostedApplicationFactory.CallOpts, authorityOwner, epochLength, claimStagingPeriod, templateHash, inputBox, withdrawalConfig, salt)
}
...
func (_ISelfHostedApplicationFactory *ISelfHostedApplicationFactoryCaller) Version(opts *bind.CallOpts) (struct {
	Major         uint64
	Minor         uint64
	Patch         uint64
	PreRelease    string
	...
	var out []interface{}
	err := _ISelfHostedApplicationFactory.contract.Call(opts, &out, "version")
...
//
// Solidity: function version() view returns(uint64 major, uint64 minor, uint64 patch, string preRelease, string buildMetadata)
func (_ISelfHostedApplicationFactory *ISelfHostedApplicationFactorySession) Version() (struct {
	Major         uint64
	Minor         uint64
	Patch         uint64
	PreRelease    string
	...
	return _ISelfHostedApplicationFactory.Contract.Version(&_ISelfHostedApplicationFactory.CallOpts)
}

// Version is a free data retrieval call binding the contract method 0x54fd4d50.
//
// Solidity: function version() view returns(uint64 major, uint64 minor, uint64 patch, string preRelease, string buildMetadata)
func (_ISelfHostedApplicationFactory *ISelfHostedApplicationFactoryCallerSession) Version() (struct {
	Major         uint64
	Minor         uint64
	Patch         uint64
	PreRelease    string
...
// DeployContracts is a paid mutator transaction binding the contract method 0xa71fe0b1.
//
// Solidity: function deployContracts(address authorityOwner, uint256 epochLength, uint256 claimStagingPeriod, bytes32 templateHash, address inputBox, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) returns(address, address)
func (_ISelfHostedApplicationFactory *ISelfHostedApplicationFactoryTransactor) DeployContracts(opts *bind.TransactOpts, authorityOwner common.Address, epochLength *big.Int, claimStagingPeriod *big.Int, templateHash [32]byte, inputBox common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (*types.Transaction, error) {
	return _ISelfHostedApplicationFactory.contract.Transact(opts, "deployContracts", authorityOwner, epochLength, claimStagingPeriod, templateHash, inputBox, withdrawalConfig, salt)
}

// DeployContracts is a paid mutator transaction binding the contract method 0xa71fe0b1.
//
// Solidity: function deployContracts(address authorityOwner, uint256 epochLength, uint256 claimStagingPeriod, bytes32 templateHash, address inputBox, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) returns(address, address)
func (_ISelfHostedApplicationFactory *ISelfHostedApplicationFactorySession) DeployContracts(authorityOwner common.Address, epochLength *big.Int, claimStagingPeriod *big.Int, templateHash [32]byte, inputBox common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (*types.Transaction, error) {
	return _ISelfHostedApplicationFactory.Contract.DeployContracts(&_ISelfHostedApplicationFactory.TransactOpts, authorityOwner, epochLength, claimStagingPeriod, templateHash, inputBox, withdrawalConfig, salt)
}

// DeployContracts is a paid mutator transaction binding the contract method 0xa71fe0b1.
//
// Solidity: function deployContracts(address authorityOwner, uint256 epochLength, uint256 claimStagingPeriod, bytes32 templateHash, address inputBox, (address,uint8,uint8,uint64,address) withdrawalConfig, bytes32 salt) returns(address, address)
func (_ISelfHostedApplicationFactory *ISelfHostedApplicationFactoryTransactorSession) DeployContracts(authorityOwner common.Address, epochLength *big.Int, claimStagingPeriod *big.Int, templateHash [32]byte, inputBox common.Address, withdrawalConfig WithdrawalConfig, salt [32]byte) (*types.Transaction, error) {
	return _ISelfHostedApplicationFactory.Contract.DeployContracts(&_ISelfHostedApplicationFactory.TransactOpts, authorityOwner, epochLength, claimStagingPeriod, templateHash, inputBox, withdrawalConfig, salt)
}
