...
// MemoryProof is the complete Merkle proof returned by the emulator for an
// aligned span of machine memory. TargetAddress and Log2TargetSize identify
// the span. The root metadata lets callers verify that the proof was produced
// for the requested machine state.
