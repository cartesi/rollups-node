...
use eth_block_history::{BlockSubscriber, SubscriptionError};
...
pub async fn create_environment(
    ...
    EthInputReaderError,
> {
    let http = Http::new(config.http_endpoint.to_owned());
    ...
    let block_subscription = subscriber
    ...
    Ok((block_subscription, env, context))
}
